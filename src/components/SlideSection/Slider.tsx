          ...
          <SwiperSlide>
            <div className="width-padding">
              <div className="grid justify-between items-center w-full md:grid-cols-1 lg:grid-cols-2 gap-y-4">
                <div className="">
                  <h1
                    className="text-title text-start"
                    style={{ fontFamily: 'monospace' }}
                  >
                    {item.title1}
                  </h1>
                  <h1
                    className="font-extrabold text-5xl text-black tracking-wide text-start"
                    style={{ fontFamily: 'monospace' }}
                  >
                    {item.title2}
                  </h1>
                  <h1
                    className="text-indigo-700 text-6xl font-extrabold tracking-wide pb-4 text-start"
                    style={{ fontFamily: 'monospace' }}
                  >
                    {item.title3}
                  </h1>
                  <h1 className=" text-indigo-900 text-start">{item.title4}</h1>
                  <div className="pl-20 pt-10">
                    <h1
                      className="w-fit bg-gradient-to-r from-indigo-700 via-purple-700 to-fuchsia-700 px-9 py-5 font-bold text-2xl text-white border rounded-lg hover:scale-110 duration-300"
                      style={{ fontFamily: 'monospace' }}
                    >
                      {data[0].title5}
                    </h1>
